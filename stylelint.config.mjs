 ...
 * Foundation ships no global reset, so there is nothing to exempt.
 */
export default {
	extends: ['stylelint-config-standard'],
	plugins: ['stylelint-declaration-strict-value'],
	// Generated file (ADR-0003) — not subject to authoring conventions.
	...
	rules: {
		...
		'scale-unlimited/declaration-strict-value': [
			...
			],
			{
				...
				message: 'Use a design token (var(--…)) instead of a literal — add a token if missing.',
			},
		],
