...
export interface IconProps extends Omit<
	...
	// these open would let a caller quietly unhide a decorative glyph, or take
	// an icon off the scale.
 ...
 * reader, and that is the common case — so it is hidden unless the caller
